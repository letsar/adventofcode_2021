void main(List<String> arguments) {
  final entries = input.split('\n').map((e) => Entry.fromString(e)).toList();
  print(puzzle0802(entries));
}
...
int puzzle0802(List<Entry> entries) {
  return entries.map((e) => Solver(e).solve()).reduce((sum, x) => sum + x);
}
...
const test =
    '''gcdfa ab dab acedgfb cdfbe fbcad cefabd cdfgeb eafb cagedb | cdfeb fcadb cdfeb cdbaf''';
